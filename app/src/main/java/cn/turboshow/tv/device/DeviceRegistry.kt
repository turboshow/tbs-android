...
import cn.turboshow.tv.device.dlna.DlnaManager
import cn.turboshow.tv.device.usb.UsbStorageManager
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class DeviceRegistry(context: Context, private val lifecycleOwner: LifecycleOwner) {
